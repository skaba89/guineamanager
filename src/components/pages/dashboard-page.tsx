...
export function DashboardPage() {
  const { dashboardStats, factures, clients, produits, employes, commandes, fetchDashboardStats } = useAppStore();
  ...
  const kpis = [
    ...
    {
      title: 'Stock bas',
      value: produitsStockBas.toString(),
      change: 'À commander',
            ...
            <div className="flex justify-between items-center p-3 rounded-lg bg-gradient-to-r from-emerald-50 to-transparent">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-emerald-600">{formatGNF(caMois)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center p-3 rounded-lg bg-gradient-to-r from-red-50 to-transparent">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-bold text-red-600">{formatGNF(depensesMois + masseSalarialeMois)}</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t">
              <div className="flex justify-between items-center">
                ...
                <span className="text-lg font-bold text-emerald-600">
                  {formatGNF(caMois - masseSalarialeMois - depensesMois)}
                </span>
              </div>
              <Progress 
                value={Math.min(100, ((caMois - masseSalarialeMois - depensesMois) / caMois) * 100)} 
                className="mt-2 h-2"
              />
              <p className="text-xs text-slate-500 mt-1">
                Marge: {((caMois - masseSalarialeMois - depensesMois) / caMois * 100).toFixed(1)}%
              </p>
            </div>
          </CardContent>
        </Card>
