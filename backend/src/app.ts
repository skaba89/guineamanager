...
import mtnMoneyRoutes from './routes/mtn-money.routes';
import waveMoneyRoutes from './routes/wave-money.routes';
import mobileMoneyDashboardRoutes from './routes/mobile-money.routes';
import webhooksRoutes from './routes/webhooks.routes';
import exportsRoutes from './routes/exports-enhanced.routes';
...
app.use('/api/paiements-mobile/orange-money', orangeMoneyRoutes);
app.use('/api/paiements-mobile/mtn', mtnMoneyRoutes);
app.use('/api/paiements-mobile/wave', waveMoneyRoutes);
app.use('/api/mobile-money', mobileMoneyDashboardRoutes);
